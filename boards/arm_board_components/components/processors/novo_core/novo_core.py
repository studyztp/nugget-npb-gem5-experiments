...
from m5.objects import ArmO3CPU, FUDesc, OpDesc, FUPool
from m5.objects.BranchPredictor import BiModeBP, SimpleBTB, ReturnAddrStack
...
class NovoCore(VectorCore):
    ...
    def __init__(self):
        ...
        requires(ISA.ARM)
        core = NovoO3CPU()
        super().__init__(ISA.ARM, core, "Novoverse")
